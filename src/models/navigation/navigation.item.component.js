...
const NavigationItem = props => {
    ...
    return (
        ...
        <li
            ...
            onMouseEnter={props.item.children || CustomComponent ? onMouseOver : null}
            onMouseLeave={props.item.children || CustomComponent ? onMouseOut : null}
        >
            {linkTo && (
            ...
            {CustomComponent && (
                <CSSTransition in={isOpen} timeout={200} classNames="slide-in" unmountOnExit>
                    <Popup class="slide-in" closePopup={() => setOpen(false)}>
                        <CustomComponent title="Need help?" helpBoxType="help-box-navigation" />
                    </Popup>
                </CSSTransition>
            )}
        </li>
