    ...
    [0],
    {
        470: function (module, __webpack_exports__, __webpack_require__) {
            ...
            var react = __webpack_require__(0),
                ...
                objectWithoutPropertiesLoose = __webpack_require__(139),
                esm_extends = __webpack_require__(32),
                inheritsLoose = __webpack_require__(112),
                ...
                return (
                    (isOffsetParentAnElement ||
                        ...
                        isHTMLElement(offsetParent)
                            ? (((offsets =
                                  getBoundingClientRect(offsetParent)).x +=
                    ...
                    var fn,
                        ...
                        instance = {
                            ...
                            setOptions: function setOptions(options) {
                                ...
                                var orderedModifiers = (function orderModifiers(
                                    modifiers
                                ) {
                                    var orderedModifiers = order(modifiers);
                                    return modifierPhases.reduce(function (
                                        acc,
                                        phase
                                    ) {
                                        return acc.concat(
                                    ...
                                    (function mergeByName(modifiers) {
                                        var merged = modifiers.reduce(function (
                                            merged,
                                            current
                                        ) {
            ...
            function detectOverflow(state, options) {
                ...
                var _options = options,
                    ...
                    altContext =
                        'popper' === elementContext ? 'reference' : 'popper',
            ...
            var popper_createPopper = popperGenerator({
                                ...
                                var state = _ref2.state,
                                    ...
                                    offset =
                                        void 0 === _options$offset
                                            ? [0, 0]
                                            : _options$offset,
                                    data = enums_placements.reduce(function (
                                        acc,
                                        placement
                                    ) {
                                        return (
                                    ...
                                    if (checkMainAxis || checkAltAxis) {
                                        var mainSide =
                                            ...
                                            clientOffset = arrowOffsetParent
                                                ? 'y' === mainAxis
                                                    ? arrowOffsetParent.clientTop ||
                                                      0
                                                    : arrowOffsetParent.clientLeft ||
                                                      0
                                                : 0,
                                            offsetModifierValue = state
                                        ...
                                        if (checkMainAxis) {
                                            var preventedOffset = within(
                                                tether
                                                    ? math_min(min, tetherMin)
                                                    : min,
                                                offset,
                                                tether
                                                    ? math_max(max, tetherMax)
                                                    : max
                                            );
                                            (popperOffsets[mainAxis] =
                                                preventedOffset),
                                                (data[mainAxis] =
                                                    preventedOffset - offset);
                                        }
                                        if (checkAltAxis) {
                                            var _mainSide =
                                                    'x' === mainAxis
                                ...
                                if (arrowElement && popperOffsets) {
                                    var paddingObject =
                                        ...
                                        clientSize = arrowOffsetParent
                                            ? 'y' === axis
                                                ? arrowOffsetParent.clientHeight ||
                                                  0
                                                : arrowOffsetParent.clientWidth ||
                                                  0
                                            : 0,
                                        centerToReference =
                ...
                react_fast_compare = __webpack_require__(929),
            ...
            function Popper(_ref) {
                var _ref$placement = _ref.placement,
                    placement =
                        void 0 === _ref$placement ? 'bottom' : _ref$placement,
                    _ref$strategy = _ref.strategy,
                    strategy =
                        void 0 === _ref$strategy ? 'absolute' : _ref$strategy,
            ...
            var warning = __webpack_require__(930),
